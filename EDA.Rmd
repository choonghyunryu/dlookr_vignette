...
```{r plot_correlate2, fig.align='center', fig.width = 6, fig.height = 4, eval=FALSE}
# Select columns by name
...
```{r plot_correlate3, fig.align='center', fig.width = 6, fig.height = 4, warning=FALSE, eval=FALSE}
carseats %>%
  filter(ShelveLoc == "Good") %>%
  group_by(Urban) %>%
