...
```{r plot_outlier, fig.align='center', fig.width = 7, fig.height = 5}
flights %>%
...
```{r plot_outlier_pipe, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
flights %>%
...
```{r plot_na_pareto1, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>% 
...
```{r plot_na_pareto2, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
mice::boys %>% 
...
```{r plot_na_pareto3, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
mice::boys %>% 
...
```{r plot_na_pareto4, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
...
```{r plot_na_hclust, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>% 
...
```{r plot_na_hclust1, fig.align='center', fig.width = 7, fig.height = 5}
mice::boys %>% 
  plot_na_intersect()
```
...
```{r plot_na_hclust3, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
mice::boys %>%
...
```{r plot_na_hclust4, fig.align='center', fig.width = 7, fig.height = 5, eval=FALSE}
mice::boys %>%
...
```{r plot_outlier_dbi, fig.align='center', fig.width = 6, fig.height = 4, eval=FALSE}
